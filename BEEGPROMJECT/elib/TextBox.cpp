...
gui::TextBox::TextBox(sf::Vector2f size, std::string label)
{
	isActive = false;
...
std::string gui::TextBox::getInput()
{
	return str;
}
...
void gui::TextBox::setColor(sf::Color FillColor, sf::Color OutlineColor, sf::Color TextColor)
{
...
void gui::TextBox::setPosition(const sf::Vector2f& pos)
{
	box.setPosition(pos);
	adjustLabel();
	adjustInputText();
...
sf::Vector2f gui::TextBox::getSize() const
{
	return box.getPosition();
}

void gui::TextBox::EventHandler(sf::Event e, const sf::RenderWindow& window)
{
	checkClick(e, window);
...
void gui::TextBox::render(sf::RenderTarget& renderTarget)
{
	adjustInputText();
...
void gui::TextBox::checkClick(sf::Event e, const sf::RenderWindow& window)
{
...
void gui::TextBox::adjustInputText()
{
